...
const ProvisionalResultsForm = () => {
  return (
    <div className="p-4 bg-white rounded shadow">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-black font-bold text-lg">PROVISIONAL RESULTS</h1>
      ...
      <div className="text-center">
        ...
        <p className="text-red-700 font-bold">YOU HAVE NO PROVISIONAL RESULTS</p>
      </div>
    </div>
  );
};

export default ProvisionalResultsForm;